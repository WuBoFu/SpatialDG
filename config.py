...
class Config(object):
    def __init__(self, config_file):
        ...
        self.delta = conf.getfloat("Model_Setup", "delta")
        self.contrastive_dim = conf.getint("Model_Setup", "contrastive_dim")
        self.use_spatial_contrastive = conf.getboolean("Model_Setup", "use_spatial_contrastive")